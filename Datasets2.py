...
class Inference_Dataset(torch.utils.data.Dataset):
    def __init__(
        ...
        for index, (duration, lyric, note, singer, genre) in enumerate(zip(durations, lyrics, notes, singers, genres)):
            ...
            lyric, note = Expand_by_Duration(lyric, note, duration)
...
class Collater:
    ...
    def __call__(self, batch):
        ...
        return tokens, notes, lengths, singers, genres, features, log_f0s, voices
...
class Inference_Collater:
    ...
    def __call__(self, batch):
        ...
        return tokens, notes, lengths, singers, genres, lyrics